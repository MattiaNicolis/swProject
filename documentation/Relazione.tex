...
\begin{document}
    ...
    \medskip
    \begin{tcolorbox}[
        title=$\textbf{UC}_\text{d}$ -- Visualizza/Modifica dati paziente,
        colback=white,
        colframe=black,
        fonttitle=\bfseries
    ]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-diabetologo.png}
        \caption{Diagramma di sequenza - Visualizza/Modifica dati paziente}
    \end{figure}
    ...
    \begin{tcolorbox}[
        ...
        \medskip
        \textbf{Postcondizioni:} notifica letta e/o comunicazione inviata
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        title = $\text{UC}_\text{p}$ - Misurazione glicemia/peso corporeo,
        colback=white,
        colframe=black,
        fonttitle=\bfseries
    ]
        ...
        \medskip
        \textbf{Precondizioni:} paziente ha effettuto correttamente l'autenticazione al sistema
        ...
        \begin{itemize}[label=$\triangleright$]
            ...
            \item paziente inserisce il valore della glicemia, il momento della misurazione e l'ora / del proprio peso corporeo
        \end{itemize}

        \medskip
        \textbf{Postcondizioni:} visualizzazione del valore inserito nel grafico
    \end{tcolorbox}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-misurazioni.png}
        \caption{Diagramma di sequenza - Misurazioni del paziente}
    \end{figure}
    ...
    \begin{tcolorbox}[
        ...
        \medskip
        \textbf{Postcondizioni:} questionario inserito nella lista dei compilati
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \medskip
        \textbf{Postcondizioni:} comunicazione inviata
    \end{tcolorbox}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-mail.png}
        \caption{Diagramma di sequenza - Invio mail}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{../documentation/images/diagramma-attività-login.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{../documentation/images/diagramma-classi.jpeg}
        \caption{Diagramma UML delle classi}
    \end{figure}
    \subsection{Controller}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/UML-controller3.jpeg}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{../documentation/images/UML-controller1.jpeg}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{../documentation/images/UML-controller2.jpeg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-loginController.png}
        \caption{Fase di autenticazione}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-terapiaController.png}
        \caption{Gestione della terapia}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-mailController.png}
        \caption{Gestione dell'invio di una mail}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{../documentation/images/sequence-diagram-pazienteController.png}
        \caption{Pagina paziente}
    \end{figure}
    ...
    Per la gestione della persistenza è stato implementato il pattern \textbf{DAO}. Questo pattern astrae e incapsula tutti gli accessi alla base di dati (CRUD), nascondendo i dettagli complessi delle query SQL al resto dell'applicazione. Grazie ai DAO, la logica dei controllori non dipende direttamente dal database, facilitando eventuali migrazioni o modifiche alla struttura dati.
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.6\linewidth]{../documentation/images/loginControllerTest1.png}
            \caption{Test di autenticazione}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\linewidth]{../documentation/images/loginControllerTest2.png}
            \caption{Impostazione e "distruzione del DAO fittizio"}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\linewidth]{../documentation/images/diabetologoPageTest1.png}
            \caption{Test della pagina del diabetologo}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\linewidth]{../documentation/images/diabetologoPageTest2.png}
            \caption{Test conteggio giorni di non compilazione}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.6\linewidth]{../documentation/images/mailControllerTest1.png}
            \caption{Test del sistema di comunicazione}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\linewidth]{../documentation/images/mailControllerTest2.png}
            \caption{Test del sistema di comunicazione: "SUCCESSO"}
        \end{figure}
        \item \textbf{Gestione Dati Pazienti:} Test approfonditi sulle operazioni di inserimento, aggiornamento ed eliminazione dati. È stata verificata la robustezza del sistema a fronte di \textit{input} non validi (es. formati errati) o dati mancanti, assicurando che le eccezioni vengano gestite senza causare crash del software.
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.6\linewidth]{../documentation/images/storiaDatiPazienteTest1.png}
            \caption{Test gestione dati paziente}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\linewidth]{../documentation/images/storiaDatiPazienteTest2.png}
            \caption{Test creazione dati paziente}
        \end{figure}
    \end{itemize}
    
    \subsection{Validazione dell'Interfaccia Grafica}
